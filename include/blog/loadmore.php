<?php
// echo str_replace("blog", "", dirname(__FILE__)); die;
require_once(str_replace("blog", "", dirname(__FILE__)).'database/connect.php');
require_once(str_replace("blog", "", dirname(__FILE__)).'config.php');
