...
<head>
	...
	<link rel="stylesheet" href="<?php echo $home_url; ?>/admin/css/lvd-tag-theme.css">
	...
	<script src="<?php echo $home_url; ?>/admin/js/lvd-tag-jquery.js"></script>
	<script src="<?php echo $home_url; ?>/admin/js/admin.js"></script>
		...
		<nav id="menu">
			<div class="container">
				...
				<ul class="main-menu">
					...
					<li><a href="<?php echo $home_url;  ?>" target="_blank">Trang web</a></li>
